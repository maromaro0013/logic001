...
/*-----------------------------------------------------------------------------
 *  時期運
 *	ネータルチャートのハウスの支配星とトランジットチャートの天体角度が、0,90,180度を組んでいる時の期間を求める
...
#ifndef _TIMINGFORTUNE005_HPP_
#define _TIMINGFORTUNE005_HPP_

#include "../astrologyBase/timingFortuneBase.hpp"

class timingFortune005 : public timingFortuneBase {
private:
