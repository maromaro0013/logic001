...
/*-----------------------------------------------------------------------------
 *  時期運
 *	ネータルチャートのハウスの支配星とトランジットチャートの天体角度が、0,60,120,180度を組んでいる時の期間を求める
...
#ifndef _TIMINGFORTUNE003_HPP_
#define _TIMINGFORTUNE003_HPP_

#include "../astrologyBase/timingFortuneBase.hpp"

class timingFortune003 : public timingFortuneBase {
private:
